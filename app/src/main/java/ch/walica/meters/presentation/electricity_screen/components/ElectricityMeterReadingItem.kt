package ch.walica.meters.presentation.electricity_screen.components
...
@Composable
fun ElectricityMeterReadingItem(meterReading: MeterReading, usage: Int, onDblClick: () -> Unit) {
